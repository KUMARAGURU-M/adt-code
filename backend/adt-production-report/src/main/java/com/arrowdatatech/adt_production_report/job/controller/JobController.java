...
public class JobController {
        ...
        // DELETE /jobs/bulk-delete - Bulk delete selected jobs
        @DeleteMapping("/bulk-delete")
        @PreAuthorize("hasAnyRole('Admin','Manager','Team Leader')")
        public ResponseEntity<ApiResponse<Integer>> bulkDelete(
                        @RequestBody BulkDeleteRequest request) {
                int deleted = jobService.bulkDelete(request.getIds());
                return ResponseEntity.ok(
                                ApiResponse.success("Bulk delete complete: " + deleted + " jobs deleted", deleted));
        }
        ...
        public ResponseEntity<ApiResponse<PagedResponse<JobResponse>>> searchProductionJobs(
                ...
                Page<JobResponse> result = jobService.searchProductionJobs(
                                ...
                                processStatus, qcStatus, startDate, endDate, page, size);
