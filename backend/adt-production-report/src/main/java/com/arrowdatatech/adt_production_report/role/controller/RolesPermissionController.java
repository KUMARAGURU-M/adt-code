...
public class RolesPermissionController {
    ...
    @GetMapping
    @PreAuthorize("hasAnyRole('Admin','Manager','Dev-role','DEV-role','dev-role','Dev-Developer') or hasAuthority('roles.view')")
    ...
    @PostMapping
    @PreAuthorize("hasAnyRole('Admin','Dev-role','DEV-role','dev-role','Dev-Developer') or hasAuthority('roles.create')")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAnyRole('Admin','Dev-role','DEV-role','dev-role','Dev-Developer') or hasAuthority('roles.delete')")
