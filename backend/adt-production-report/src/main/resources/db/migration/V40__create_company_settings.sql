...
CREATE TABLE company_settings (
    ...
    allowed_types VARCHAR(255) NOT NULL DEFAULT 'jpg,jpeg,png,pdf,doc,docx',
    enable_thirukkural BOOLEAN NOT NULL DEFAULT TRUE,
    thirukkural_translation VARCHAR(50) NOT NULL DEFAULT 'all',
